...
@synthesize position;
@synthesize uvCoordinate;

-(void) setup:(NSXMLElement*) xml{
	self.position = CGPointMake(
										[self number:xml forAttribute:@"x"],
										[self number:xml forAttribute:@"y"]	);
	self.uvCoordinate = CGPointMake(
															[self number:xml forAttribute:@"u"],
															[self number:xml forAttribute:@"v"]	);
