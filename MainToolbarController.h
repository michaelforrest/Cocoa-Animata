...
@interface MainToolbarController : NSObject {
	IBOutlet ToolController * toolController;
	IBOutlet NSToolbar * toolbar;
	
	IBOutlet NSToolbarItem * select;
	IBOutlet NSToolbarItem * drawTriangles;	
	IBOutlet NSToolbarItem * pan;
	NSDictionary * toolMappings;
}
