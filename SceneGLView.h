...
@interface SceneGLView : AnimataGLView {
	IBOutlet LayersController * layersController;
}
@property (nonatomic, retain) IBOutlet LayersController *layersController;
@property (nonatomic, retain) Camera *camera;
@property (nonatomic, retain) ToolController *toolController;
